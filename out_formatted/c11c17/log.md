...
|[0432](../c11c17/log.md#issue0432)|Is `0.0` required to be a representable value?|Closed|
...
|[0469](../c11c17/log.md#issue0469)|lock ownership vs. thread termination|Closed|
...
> These issues are covered under [DR 416](../c11c17/log.md#issue0416). See discussion there.

Apr 2013 meeting

### Committee Discussion

> In addition to [DR 416](../c11c17/log.md#issue0416) this report suggests defining as undefined
...
> 416](../c11c17/log.md#issue0416) and are jointly resolved in that DR's Proposed Technical
> Corrigendum.
...
Status: Closed  
Cross-references: [0423](../c11c17/log.md#issue0423), [0454](../c11c17/log.md#issue0454)  
Converted from: [n2396.htm](https://www.open-std.org/jtc1/sc22/wg14/www/docs/n2396.htm)
...
* Qualifiers on the return type of a function are superfluous since by resolution to [DR 423](../c11c17/log.md#issue0423) the committee affirms that qualifiers are dropped as part of the evaluation of expressions including function calls.
...
> the Proposed Technical Corrigendum of [DR 423](../c11c17/log.md#issue0423). The treatment of
...
Status: Fixed  
Fixed in: C17  
Cross-references: [0433](../c11c17/log.md#issue0433)  
Converted from: [n2396.htm](https://www.open-std.org/jtc1/sc22/wg14/www/docs/n2396.htm)
...
* Further investigation confirmed that there were several other functions that also need similar corrections to their runtime constraints. All of these additional functions also need additional corrections as specified in [DR433,](../c11c17/log.md#issue0433) and the full resolution of both this defect and the additional issue will be found in the Proposed Technical Corrigendum of [DR433.](../c11c17/log.md#issue0433)
* That list is:
...
* As such, the committee continues to accept unchanged the Proposed Technical Corrigendum as partial fulfillment of this defect, and that full resolution of the other similar defects will be found in [DR433.](../c11c17/log.md#issue0433)
...
Status: Fixed  
Fixed in: C17  
Cross-references: [0423](../c11c17/log.md#issue0423), [0474](../c11c17/log.md#issue0474)  
Converted from: [n2396.htm](https://www.open-std.org/jtc1/sc22/wg14/www/docs/n2396.htm)
...
Status: Closed  
Cross-references: [0467](../c11c17/log.md#issue0467)  
Converted from: [n2396.htm](https://www.open-std.org/jtc1/sc22/wg14/www/docs/n2396.htm)
...
reopened. Combining this PTC with that of [**<ins>DR 467</ins>**](../c11c17/log.md#issue0467)
...
> and asks that this proposed change and that from [CR 467](../c11c17/log.md#issue0467) be
...
Status: Fixed  
Fixed in: C17  
Cross-references: [0428](../c11c17/log.md#issue0428)  
Converted from: [n2396.htm](https://www.open-std.org/jtc1/sc22/wg14/www/docs/n2396.htm)
...
* These changes also address, where noted, the defect reported in [DR428.](../c11c17/log.md#issue0428)
...
Authors: WG 14, Fred J. Tydeman  
Date: 2013-08-20  
Reference document: [N1739,](https://www.open-std.org/jtc1/sc22/wg14/www/docs/n1739.htm) [DR 285](../c99/log.md#issue0285)  
Status: Fixed  
Fixed in: C17  
Cross-references: [0285](../c99/log.md#issue0285)  
Converted from: [n2396.htm](https://www.open-std.org/jtc1/sc22/wg14/www/docs/n2396.htm)
...
Authors: WG 14, Fred J. Tydeman  
Date: 2013-08-20  
Reference document: [N1740,](https://www.open-std.org/jtc1/sc22/wg14/www/docs/n1740.htm) [DR 231](../c99/log.md#issue0231), [DR 250](../c99/log.md#issue0250)  
Status: Fixed  
Fixed in: C17  
Cross-references: [0231](../c99/log.md#issue0231), [0250](../c99/log.md#issue0250)  
Converted from: [n2396.htm](https://www.open-std.org/jtc1/sc22/wg14/www/docs/n2396.htm)
...
[DR 231](../c99/log.md#issue0231) Says that text-line and non-directive are not
...
[DR 250](../c99/log.md#issue0250) Says that non-directive is a preprocessing directive. And,
...
Status: Closed  
Cross-references: [0260](../c99/log.md#issue0260)  
Converted from: [n2396.htm](https://www.open-std.org/jtc1/sc22/wg14/www/docs/n2396.htm)
...
On the one hand the committee response to [Defect Report #260](../c99/log.md#issue0260)
...
Status: Closed  
Cross-references: [0422](../c11c17/log.md#issue0422), [0427](../c11c17/log.md#issue0427)  
Converted from: [n2396.htm](https://www.open-std.org/jtc1/sc22/wg14/www/docs/n2396.htm)
...
Status: Closed  
Cross-references: [0432](../c11c17/log.md#issue0432)  
Converted from: [n2396.htm](https://www.open-std.org/jtc1/sc22/wg14/www/docs/n2396.htm)
...
>
> Further, after discussion, the change from [DR 432](../c11c17/log.md#issue0432) is now viewed as
...
>
> The committee is now considering changes for the next revision of the standard,
> and asks that this proposed change and that from [CR 432](../c11c17/log.md#issue0432) be
> combined in a new paper to completely resolve this issue.
...
Status: Closed  
Cross-references: [0414](../c11c17/log.md#issue0414), [0416](../c11c17/log.md#issue0416), [0479](../c11c17/log.md#issue0479), [0493](../c11c17/log.md#issue0493)  
Converted from: [n2396.htm](https://www.open-std.org/jtc1/sc22/wg14/www/docs/n2396.htm)
...
> was presented.
>
> Issue 1 from that paper has already been addressed in [DR414](../c11c17/log.md#issue0414)
>
...
> the resolution to [DR 414](../c11c17/log.md#issue0414) be folded into any Suggested Technical
> Corrigendum as well.
...
> reconciled with the first item from the PTC of [DR 416](../c11c17/log.md#issue0416). It was also
> suggested that “or through program termination” be added.
>
> [DR 479](../c11c17/log.md#issue0479) and [DR 493](../c11c17/log.md#issue0493) raise other issues that must be
...
> in [DR 479](../c11c17/log.md#issue0479) and [DR 493](../c11c17/log.md#issue0493).
>
...
>
> The committee is now considering changes for the next revision of the standard,
> and asks that issues from [CR 469](../c11c17/log.md#issue0469), [CR 479](../c11c17/log.md#issue0479), and [CR
> 493](../c11c17/log.md#issue0493), as well as potentially other small issues be combined in a new
...
Status: Closed  
Cross-references: [0431](../c11c17/log.md#issue0431)  
Converted from: [n2396.htm](https://www.open-std.org/jtc1/sc22/wg14/www/docs/n2396.htm)
...
> This change, especially in light of [DR431](../c11c17/log.md#issue0431), was thought to likely
...
* Coordinated new wording is solicited from the authors to both this and the solicited author for the resolution of [DR 469](../c11c17/log.md#issue0469) since it also is proposing potentially overlapping wording changes in this area.

Apr 2016 meeting

### Committee Discussion

> This resolution continues to be bound to [DR 469](../c11c17/log.md#issue0469)
...
> with those raised in [DR 469](../c11c17/log.md#issue0469) and [DR 493](../c11c17/log.md#issue0493). The authors
...
Status: Closed  
Cross-references: [0495](../c11c17/log.md#issue0495)  
Converted from: [n2396.htm](https://www.open-std.org/jtc1/sc22/wg14/www/docs/n2396.htm)
...
> that raised in [DR 495](../c11c17/log.md#issue0495).
...
>
> The committee is now considering changes for the next revision of the standard,
> and asks that this proposed change and that from [CR 495](../c11c17/log.md#issue0495) be
> combined in a new paper to completely resolve this issue.
...
Status: Closed  
Cross-references: [0414](../c11c17/log.md#issue0414), [0469](../c11c17/log.md#issue0469), [0479](../c11c17/log.md#issue0479)  
Converted from: [n2396.htm](https://www.open-std.org/jtc1/sc22/wg14/www/docs/n2396.htm)
...
5. The function description specifies that the `type` argument must have one of six values but lists only four. What are the remaining two values of the `type` argument? (Note: this problem is the subject of DR [479](../c11c17/log.md#issue0479).)
...
> resolution to [DR 469](../c11c17/log.md#issue0469) must include a Proposed Technical Corrigendum
> consistent with the answers provided below.
>
> As one example required to be resolved in [DR 469](../c11c17/log.md#issue0469),
>
...
>
> The committee solicited a combined comprehensive resolution for these issues
> with those raised in [DR 469](../c11c17/log.md#issue0469) and [DR 479](../c11c17/log.md#issue0479).
...
> made in [DR 469](../c11c17/log.md#issue0469).
>
> **Problems with `mtx_t`**
>
...
> 5. See [DR 414](../c11c17/log.md#issue0414) for the resolution to the miscounted variations of `mtx_init()` options.
...
> 3. Calling `mtx_destroy()` while it is locked is intended to be undefined and will be resolved by [DR 469](../c11c17/log.md#issue0469).
...
Reference document: [N2027](https://www.open-std.org/jtc1/sc22/wg14/www/docs/n2025.htm)  
Status: Closed  
Cross-references: [0486](../c11c17/log.md#issue0486)  
Converted from: [n2396.htm](https://www.open-std.org/jtc1/sc22/wg14/www/docs/n2396.htm)
...
> in [DR 486](../c11c17/log.md#issue0486).
...
>
> The committee is now considering changes for the next revision of the standard,
> and asks that this proposed change and that from [CR 486](../c11c17/log.md#issue0486) be
> combined in a new paper to completely resolve this issue.
...
Status: Fixed  
Fixed in: C23  
Cross-references: [0502](../c11c17/log.md#issue0502)  
Converted from: [n2396.htm](https://www.open-std.org/jtc1/sc22/wg14/www/docs/n2396.htm)
...
>
> A related issue is to be found in [DR 502](../c11c17/log.md#issue0502) and both may be resolved
...
Status: Closed  
Cross-references: [0499](../c11c17/log.md#issue0499)  
Converted from: [n2396.htm](https://www.open-std.org/jtc1/sc22/wg14/www/docs/n2396.htm)
...
DR [499](../c11c17/log.md#issue0499).
...
>
> This issue might also be resolved via [DR 499](../c11c17/log.md#issue0499)
