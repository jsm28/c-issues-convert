...
|-|-|-|
|[0201](../c99/log.md#issue0201)|Integer types longer than `long`|Closed|
|[0202](../c99/log.md#issue0202)|Change return type of certain `<fenv.h>` functions|Fixed in C99 TC1|
|[0203](../c99/log.md#issue0203)|C locale conflict with ISO/IEC 9945-2|Fixed in C99|
|[0204](../c99/log.md#issue0204)|`size_t` and `ptrdiff_t` as a `long long` type|Fixed in C99 TC1|
|[0205](../c99/log.md#issue0205)|New keyword `__at_least`|Closed|
|[0206](../c99/log.md#issue0206)|Default argument conversion of `float _Complex`|Closed|
|[0207](../c99/log.md#issue0207)|Handling of imaginary types|Fixed in C99 TC2|
|[0208](../c99/log.md#issue0208)|Ambiguity in initialization|Fixed in C99 TC1|
|[0209](../c99/log.md#issue0209)|Problem implementing `INT`*N*`_C` macros|Fixed in C99 TC1|
|[0210](../c99/log.md#issue0210)|`fprintf %a` and `%A` conversions recommended practice|Fixed in C99 TC1|
|[0211](../c99/log.md#issue0211)|Accuracy of decimal string to/from "binary" (non-decimal) floating-point conversions|Fixed in C99 TC2|
|[0212](../c99/log.md#issue0212)|Binding of multibyte conversion state objects|Closed|
|[0213](../c99/log.md#issue0213)|Lacuna in `mbrtowc`|Fixed in C99 TC1|
|[0214](../c99/log.md#issue0214)|`atexit` function registration|Closed|
|[0215](../c99/log.md#issue0215)|Equality operators|Fixed in C99 TC2|
|[0216](../c99/log.md#issue0216)|Source character encodings|Fixed in C99 TC1|
|[0217](../c99/log.md#issue0217)|`asctime` limits|Closed|
|[0218](../c99/log.md#issue0218)|Signs of non-numeric floating point values|Fixed in C99 TC2|
|[0219](../c99/log.md#issue0219)|Effective types|Closed|
|[0220](../c99/log.md#issue0220)|Definition of "decimal integer"|Fixed in C99 TC1|
|[0221](../c99/log.md#issue0221)|Lacuna in pointer arithmetic|Closed|
|[0222](../c99/log.md#issue0222)|Partially initialized structures|Fixed in C99 TC2|
|[0223](../c99/log.md#issue0223)|`FP_FAST_FMAF` and `FP_FAST_FMAL` should be integer constant|Fixed in C99 TC2|
|[0224](../c99/log.md#issue0224)|`fpclassify` return is not defined|Fixed in C99 TC2|
|[0225](../c99/log.md#issue0225)|`strtod`, `strtof` and `strtold` expected form of the subject sequence|Fixed in C99 TC2|
|[0226](../c99/log.md#issue0226)|`strftime` references|Closed|
|[0227](../c99/log.md#issue0227)|`strftime %U`, `%V`, and `%W` conversion specifiers|Closed|
|[0228](../c99/log.md#issue0228)|`wmemcmp` declaration in Annex B|Fixed in C99 TC1|
|[0229](../c99/log.md#issue0229)|`localeconv() *_sep_by_space` table entries issues|Fixed in C99 TC2|
|[0230](../c99/log.md#issue0230)|Enumerated type rank|Fixed in C99 TC2|
|[0231](../c99/log.md#issue0231)|Semantics of *text-line* and *non-directive*|Closed|
|[0232](../c99/log.md#issue0232)|Typo in Annex I|Fixed in C99 TC1|
|[0233](../c99/log.md#issue0233)|`%g`, `%G` precision specification|Fixed in C99 TC2|
|[0234](../c99/log.md#issue0234)|Miscellaneous Typos|Fixed in C99 TC1|
|[0235](../c99/log.md#issue0235)|"`C`" locale collating behaviour not defined|Closed|
|[0236](../c99/log.md#issue0236)|The interpretation of type based aliasing rule when applied to union objects or allocated objects|Closed|
|[0237](../c99/log.md#issue0237)|Declarations using `[static]`|Closed|
|[0238](../c99/log.md#issue0238)|Decriptions of `fma()` overflow and underflow errors are missing|Fixed in C99 TC2|
|[0239](../c99/log.md#issue0239)|Annex F `nexttoward` description is inconsistent with 7.12.11.4. and F.9.8.3|Fixed in C99 TC2|
|[0240](../c99/log.md#issue0240)|`lrint`, `llrint`, `lround`, `llround`, and `ilogb` descriptions are not consistent for unrepresentable results|Fixed in C99 TC2|
|[0241](../c99/log.md#issue0241)|Make the base standard and Annex F consistent for `pow(0, <0)`|Fixed in C99 TC2|
|[0242](../c99/log.md#issue0242)|Make the base standard and Annex F consistent for `logb(0)`|Fixed in C99 TC2|
|[0243](../c99/log.md#issue0243)|Make the base standard and Annex F consistent for `fmod()`, `remainder()`, and `remquo()` for a zero divisor|Fixed in C99 TC2|
|[0244](../c99/log.md#issue0244)|`tgamma(zero or negative integer)` should be considered a pole error|Fixed in C99 TC2|
|[0245](../c99/log.md#issue0245)|Missing paragraph numbers|Fixed in C99 TC2|
|[0246](../c99/log.md#issue0246)|completion of declarators|Closed|
|[0247](../c99/log.md#issue0247)|are values a form of behaviour ?|Fixed in C99 TC2|
|[0248](../c99/log.md#issue0248)|limits are required for optional types|Fixed in C99 TC2|
|[0249](../c99/log.md#issue0249)|Lacuna applying C89:TC1 to C99|Fixed in C99 TC2|
|[0250](../c99/log.md#issue0250)|non-directives within macro arguments|Fixed in C99 TC2|
|[0251](../c99/log.md#issue0251)|are `struct fred` and `union fred` the same type ?|Fixed in C99 TC3|
|[0252](../c99/log.md#issue0252)|incomplete argument types when calling non-prototyped functions|Fixed in C99 TC3|
|[0253](../c99/log.md#issue0253)|"overriding" in designated initializers|Closed|
|[0254](../c99/log.md#issue0254)|`mbtowc` and partial characters|Closed|
|[0255](../c99/log.md#issue0255)|non-prototyped function calls and argument mismatches|Closed|
|[0256](../c99/log.md#issue0256)|multiple inclusion of headers|Closed|
|[0257](../c99/log.md#issue0257)|common initial sequences and related issues with unions|Closed|
|[0258](../c99/log.md#issue0258)|ordering of "defined" and macro replacement|Closed|
|[0259](../c99/log.md#issue0259)|macro invocations with no arguments|Closed|
|[0260](../c99/log.md#issue0260)|indeterminate values and identical representations|Closed|
|[0261](../c99/log.md#issue0261)|constant expressions|Closed|
|[0262](../c99/log.md#issue0262)|maximum size of bit fields|Fixed in C99 TC2|
|[0263](../c99/log.md#issue0263)|all-zero bits representations|Fixed in C99 TC2|
|[0264](../c99/log.md#issue0264)|graphic characters|Closed|
|[0265](../c99/log.md#issue0265)|preprocessor arithmetic|Fixed in C99 TC2|
|[0266](../c99/log.md#issue0266)|overflow of `sizeof`|Closed|
|[0267](../c99/log.md#issue0267)|Typos in 5.1.2.3, 7.24.4.4.5, 7.24.6.1, 7.24.6.1|Fixed in C99 TC2|
|[0268](../c99/log.md#issue0268)|jumps into iteration statements|Fixed in C99 TC3|
|[0269](../c99/log.md#issue0269)|lacunae in exact-width integer types|Fixed in C99 TC2|
|[0270](../c99/log.md#issue0270)|`wint_t` is not the promoted version of `wchar_t`|Fixed in C99 TC2|
|[0271](../c99/log.md#issue0271)|lacuna in `iswctype` and `towctrans`|Closed|
|[0272](../c99/log.md#issue0272)|type category|Fixed in C99 TC2|
|[0273](../c99/log.md#issue0273)|meaning of `__STDC_ISO_10646__`|Fixed in C99 TC2|
|[0274](../c99/log.md#issue0274)|meaning of "character" in \<string,h\> functions|Fixed in C99 TC2|
|[0275](../c99/log.md#issue0275)|bitwise-OR of nothing|Fixed in C99 TC2|
|[0276](../c99/log.md#issue0276)|orientation of `perror`|Fixed in C99 TC2|
|[0277](../c99/log.md#issue0277)|declarations within iteration statements|Closed|
|[0278](../c99/log.md#issue0278)|lacuna in character encodings|Fixed in C99 TC2|
|[0279](../c99/log.md#issue0279)|Wide character code values for members of the basic character set|Fixed in C99 TC2|
|[0280](../c99/log.md#issue0280)|`struct tm`, member `tm_isdst`, and `mktime()` in `<time.h>`|Closed|
|[0281](../c99/log.md#issue0281)|CLOCKS\_PER\_SEC should not be a constant expression|Fixed in C99 TC2|
|[0282](../c99/log.md#issue0282)|flexible array members \& struct padding|Fixed in C99 TC2|
|[0283](../c99/log.md#issue0283)|Accessing a non-current union member ("type punning")|Fixed in C99 TC3|
|[0284](../c99/log.md#issue0284)|Does \<math.h\> define `INT_MIN` and `INT_MAX`?|Closed|
|[0285](../c99/log.md#issue0285)|Conversion of an `imaginary` type to `_Bool`|Fixed in C99 TC2|
|[0286](../c99/log.md#issue0286)|Correctly rounded and rounding direction/mode|Fixed in C99 TC3|
|[0287](../c99/log.md#issue0287)|Floating-point status flags and sequence points|Fixed in C99 TC3|
|[0288](../c99/log.md#issue0288)|deficiency on multibyte conversions|Closed|
|[0289](../c99/log.md#issue0289)|Function prototype with \[restrict\]|Fixed in C99 TC3|
|[0290](../c99/log.md#issue0290)|`FLT_EVAL_METHOD` and extra precision and/or range|Fixed in C99 TC3|
|[0291](../c99/log.md#issue0291)|corrections to requirements on inexact floating-point exceptions|Fixed in C99 TC3|
|[0292](../c99/log.md#issue0292)|Use of the word *variable*|Fixed in C99 TC3|
|[0293](../c99/log.md#issue0293)|Typo in Standard \- `double complex` instead of `complex` in an example|Fixed in C99 TC3|
|[0294](../c99/log.md#issue0294)|Technical question on C99 `restrict` keyword|Closed|
|[0295](../c99/log.md#issue0295)|Incomplete types for function parameters|Fixed in C99 TC3|
|[0296](../c99/log.md#issue0296)|Is `exp(INFINITY)` overflow? A range error? A divide-by-zero exception? `INFINITY` without any errors?|Fixed in C99 TC3|
|[0297](../c99/log.md#issue0297)|May `FE_*` floating-point exception flags have bits in common?|Fixed in C99 TC3|
|[0298](../c99/log.md#issue0298)|Validity of constant in `unsigned long long` range|Fixed in C99 TC3|
|[0299](../c99/log.md#issue0299)|Is `cabs()` a type-generic macro?|Fixed in C99 TC3|
|[0300](../c99/log.md#issue0300)|Translation-time expresssion evaluation|Closed|
|[0301](../c99/log.md#issue0301)|Meaning of FE\_\* macros in \<fenv.h\>|Closed|
|[0302](../c99/log.md#issue0302)|6.10.2p5: Adding underscore to portable include file name character set|Fixed in C99 TC3|
|[0303](../c99/log.md#issue0303)|6.10p2: Breaking up the very long sentence describing preprocessing directive|Fixed in C99 TC3|
|[0304](../c99/log.md#issue0304)|Clarifying illegal tokens in `#if` directives|Fixed in C99 TC3|
|[0305](../c99/log.md#issue0305)|6.10.1p3: Clarifying handling of keywords in `#if` directives|Fixed in C99 TC3|
|[0306](../c99/log.md#issue0306)|6.10.3p9: Clarifying that rescanning applies to object-like macros|Fixed in C99 TC3|
|[0307](../c99/log.md#issue0307)|6.10.3p10: Clarifiying arguments vs. parameters|Fixed in C99 TC3|
|[0308](../c99/log.md#issue0308)|Clarify that source files et al. need not be "files"|Fixed in C99 TC3|
|[0309](../c99/log.md#issue0309)|Clarifying trigraph substitution|Fixed in C99 TC3|
|[0310](../c99/log.md#issue0310)|Add non-corner case example of trigraphs|Fixed in C99 TC3|
|[0311](../c99/log.md#issue0311)|Definition of variably modified types|Fixed in C99 TC3|
|[0312](../c99/log.md#issue0312)|Meaning of "known constant size"|Fixed in C99 TC3|
|[0313](../c99/log.md#issue0313)|Incomplete arrays of VLAs|Closed|
|[0314](../c99/log.md#issue0314)|Cross-translation-unit tagged type compatibility|Closed|
|[0315](../c99/log.md#issue0315)|Implementation-defined bit-field types|Fixed in C11|
|[0316](../c99/log.md#issue0316)|Unprototyped function types|Closed|
|[0317](../c99/log.md#issue0317)|Function definitions with empty parentheses|Closed|
|[0318](../c99/log.md#issue0318)|`(double)0.1f` with `FLT_EVAL_METHOD` being 2|Fixed in C99 TC3|
|[0319](../c99/log.md#issue0319)|printf("%a", 1.0) and trailing zeros|Closed|
|[0320](../c99/log.md#issue0320)|Scope of variably modified type|Fixed in C99 TC3|
|[0321](../c99/log.md#issue0321)|Wide character code values for members of the basic character set|Fixed in C99 TC3|
|[0322](../c99/log.md#issue0322)|Problem with TC2 Change #67 (Add `perror` to the list defining byte input/output functions.)|Fixed in C99 TC3|
|[0323](../c99/log.md#issue0323)|Potential problems with TC2 #34, #35, and #36|Fixed in C99 TC3|
|[0324](../c99/log.md#issue0324)|Tokenization obscurities|Fixed in C99 TC3|
|[0325](../c99/log.md#issue0325)|`strerror()`|Closed|
|[0326](../c99/log.md#issue0326)|`asctime()`|Fixed in C11|
|[0327](../c99/log.md#issue0327)|Italicize definition of variable length array type, add forward references|Fixed in C11|
|[0328](../c99/log.md#issue0328)|String literals in compound literal initialization|Fixed in C11|
|[0329](../c99/log.md#issue0329)|Math functions and directed rounding|Fixed in C11|
|[0330](../c99/log.md#issue0330)|Externally visible exceptional conditions|Fixed in C11|
|[0331](../c99/log.md#issue0331)|permit `FE_DIVBYZERO` when `errno` says `EDOM`|Closed|
|[0332](../c99/log.md#issue0332)|`gets` is generally unsafe|Fixed in C99 TC3|
|[0333](../c99/log.md#issue0333)|Missing Predefined Macro Name|Fixed in C99 TC3|
|[0334](../c99/log.md#issue0334)|Missing semantics of comparison macros|Closed|
|[0335](../c99/log.md#issue0335)|\_Bool bit-fields|Closed|
|[0336](../c99/log.md#issue0336)|`TMP_MAX`|Fixed in C11|
|[0337](../c99/log.md#issue0337)|`stdio.h` macro definition problems|Closed|
|[0338](../c99/log.md#issue0338)|C99 seems to exclude **indeterminate value** from being an uninitialized register|Fixed in C11|
|[0339](../c99/log.md#issue0339)|Variably modified compound literals|Fixed in C11|
|[0340](../c99/log.md#issue0340)|Composite types for variable-length arrays|Fixed in C11|
|[0341](../c99/log.md#issue0341)|`[*]` in abstract declarators|Fixed in C11|
|[0342](../c99/log.md#issue0342)|VLAs and conditional expressions|Fixed in C11|
|[0343](../c99/log.md#issue0343)|Initializing qualified wchar\_t arrays|Fixed in C11|
|[0344](../c99/log.md#issue0344)|Casts in preprocessor conditional expressions|Fixed in C11|
|[0345](../c99/log.md#issue0345)|Where does parameter scope start?|Fixed in C11|
...
Date: 2000-04-04  
Status: Closed  
Cross-references: [0326](../c99/log.md#issue0326)  
...
Date: 2000-04-14  
Status: Closed  
Cross-references: [0448](../c11c17/log.md#issue0448)  
...
Date: 2000-10-18  
Status: Closed  
Cross-references: [0257](../c99/log.md#issue0257)  
...
Status: Fixed  
Fixed in: C99 TC2  
Cross-references: [0303](../c99/log.md#issue0303), [0448](../c11c17/log.md#issue0448)  
...
Date: 2001-09-07  
Status: Closed  
Cross-references: [0413](../c11c17/log.md#issue0413)  
...
Date: 2001-09-07  
Status: Closed  
Cross-references: [0316](../c99/log.md#issue0316)  
...
Date: 2001-09-07  
Status: Closed  
Cross-references: [0236](../c99/log.md#issue0236), [0283](../c99/log.md#issue0283)  
...
2. This takes away the "visibility rule" and the Committee does not want to do that; this is related to [DR 236](../c99/log.md#issue0236).
...
4. The Committee believes this is a separate issue, and should be a defect report (and possibly a new footnote). The defect report generated is [DR 283](../c99/log.md#issue0283), also see [N980](https://www.open-std.org/jtc1/sc22/wg14/www/docs/n980.htm).
...
Date: 2001-09-07  
Status: Closed  
Cross-references: [0451](../c11c17/log.md#issue0451)  
...
Status: Fixed  
Fixed in: C99 TC2  
Cross-references: [0335](../c99/log.md#issue0335)  
...
Status: Fixed  
Fixed in: C99 TC2  
Cross-references: [0322](../c99/log.md#issue0322)  
...
Status: Fixed  
Fixed in: C99 TC2  
Cross-references: [0321](../c99/log.md#issue0321)  
...
*\[This report isolates one of the points from [DR257](../c99/log.md#issue0257).\]*
...
*\[Essentially verbatim from [DR257](../c99/log.md#issue0257)\]*
...
Status: Fixed  
Fixed in: C99 TC2  
Cross-references: [0447](../c11c17/log.md#issue0447)  
...
Authors: WG 14, Fred Tydeman (USA)  
Date: 2003-04-13  
Reference document: [ISO/IEC WG14 C90 DR 087](../c90/log.md#issue0087)  
Status: Fixed  
Fixed in: C99 TC3  
Cross-references: [0087](../c90/log.md#issue0087)  
...
As noted in the response to [DR 087](../c90/log.md#issue0087), function calls in the same
...
Status: Fixed  
Fixed in: C99 TC3  
Cross-references: [0250](../c99/log.md#issue0250)  
...
TC2 (and specifically [DR 250](../c99/log.md#issue0250)) changed that sentence into a
definition.
...
Status: Closed  
Cross-references: [0255](../c99/log.md#issue0255)  
...
Per the response provided in [DR 255](../c99/log.md#issue0255):
...
Date: 2005-04-26  
Reference document: [DR\_279](../c99/log.md#issue0279), [Austin Group Aardvark comment XBD ERN 53](http://www.opengroup.org/austin/aardvark/latest/xbdbug2.txt)  
Status: Fixed  
Fixed in: C99 TC3  
Cross-references: [0279](../c99/log.md#issue0279), [0333](../c99/log.md#issue0333)  
...
Date: 2005-09-28  
Reference document: [Defect Report #276](../c99/log.md#issue0276)  
Status: Fixed  
Fixed in: C99 TC3  
Cross-references: [0276](../c99/log.md#issue0276)  
...
Date: 2006-03-28  
Reference document: [AI-053.txt](http://www.opengroup.org/austin/interps/protected/uploads/20/9920/AI-053.txt), [DR 217](../c99/log.md#issue0217)  
Status: Fixed  
Fixed in: C11  
Cross-references: [0217](../c99/log.md#issue0217)  
...
**Note:** This appears to be a duplicate of [DR 217](../c99/log.md#issue0217), which advises
...
Status: Fixed  
Fixed in: C11  
Cross-references: [0339](../c99/log.md#issue0339)  
...
Authors: Austin Group, Nick Stoughton (US)  
Date: 2006-10-24  
Reference document: [DR\_321](../c99/log.md#issue0321),  
Status: Fixed  
Fixed in: C99 TC3  
Cross-references: [0321](../c99/log.md#issue0321)  
...
Defect report [DR\_321](../c99/log.md#issue0321) introduced a new pre-defined macro name,
...
Authors: WG 14, Fred Tydeman (USA)  
Date: 2006-12-12  
Reference document: [ISO/IEC WG14 N1204](https://www.open-std.org/jtc1/sc22/wg14/www/docs/n1204.htm), [ISO/IEC WG14 DR 262](../c99/log.md#issue0262), [ISO/IEC WG14 DR 315](../c99/log.md#issue0315)  
Status: Closed  
Cross-references: [0262](../c99/log.md#issue0262), [0315](../c99/log.md#issue0315)  
...
Status: Fixed  
Fixed in: C11  
Cross-references: [0328](../c99/log.md#issue0328)  
...
This defect report is answered by [DR 328](../c99/log.md#issue0328).
...
Status: Fixed  
Fixed in: C11  
Cross-references: [0342](../c99/log.md#issue0342)  
...
Status: Fixed  
Fixed in: C11  
Cross-references: [0340](../c99/log.md#issue0340)  
...
interpretation of composite type rules as in [DR 340](../c99/log.md#issue0340), so this
...
See [defect report 340](../c99/log.md#issue0340)
