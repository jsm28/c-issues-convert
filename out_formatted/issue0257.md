...
Status: Closed  
Cross-references: [0236](issue0236.md), [0283](issue0283.md)  
...
2. This takes away the "visibility rule" and the Committee does not want to do that; this is related to [DR 236](issue0236.md).
...
4. The Committee believes this is a separate issue, and should be a defect report (and possibly a new footnote). The defect report generated is [DR 283](issue0283.md), also see [N980](https://www.open-std.org/jtc1/sc22/wg14/www/docs/n980.htm).
